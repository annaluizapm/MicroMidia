...
async function handleCadastro(event) {
    ...
    if (nome && email && senha) {
        ...
        if (usuario) {
            console.log('✅ Usuário criado com sucesso, processando foto...');
            ...
            setTimeout(() => {
                ...
                try {
                    // Tentar diferentes formas de redirecionamento
                    const currentPath = window.location.pathname;
                    console.log('📍 Caminho atual:', currentPath);
                    
                    // Se estamos na pasta HTML, usar caminho relativo
            ...
            mostrarMensagem('Erro ao criar usuário. Tente novamente.', 'erro');
        }
    } else {
