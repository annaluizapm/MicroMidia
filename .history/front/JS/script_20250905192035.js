...
function verificarUsuarioLogado() {
    const usuarioLogado = localStorage.ge        // Imagem do perfil do usuário
...
async function handleCadastro(event) {
    ...
    // Obter a foto de perfil se houver
    let fotoBase64 = '';
    ...
    if (nome && email && senha) {
        const usuario = await criarUsuario(nome, email, senha, bio, fotoBase64);
        if (usuario) {
